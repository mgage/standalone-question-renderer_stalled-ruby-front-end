...
package WeBWorK::PG::Local2;
use base qw (RenderProblem);    #allows us to find defineProblemEnvir in RenderProblem
...
use constant TIMEOUT => $WeBWorK::PG::Local2::TIMEOUT || 10;
...
BEGIN {
	...
	$WeBWorK::PG::Local2::safeCache = new WWSafe;
}
...
# 	
    ...
    #print "options environment ", $more_options->{rh};
     my $rh = $more_options->{rh};
#     my $envir = $more_options->{rh}->{envir};
